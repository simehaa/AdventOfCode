...
if best_views_nsew[0] == best_position[0]:
    reasons[0] = "all the way to the edge of the forest"
if best_views_nsew[1] == height - best_position[0] - 1:
    reasons[1] = "all the way to the edge of the forest"
if best_views_nsew[2] == width - best_position[1] - 1:
    reasons[2] = "all the way to the edge of the forest"
if best_views_nsew[3] == best_position[1]:
    reasons[3] = "all the way to the edge of the forest"
